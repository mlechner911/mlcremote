import {
  require_standalone
} from "./chunk-O6WWGGOB.js";
import {
  __commonJS
} from "./chunk-Y2F7D3TJ.js";

// node_modules/prettier-plugin-toml/lib/loc.js
var require_loc = __commonJS({
  "node_modules/prettier-plugin-toml/lib/loc.js"(exports2, module2) {
...
// node_modules/@toml-tools/lexer/lib/tokens.js
var require_tokens2 = __commonJS({
  "node_modules/@toml-tools/lexer/lib/tokens.js"(exports2, module2) {
    "use strict";
    var { createToken: createTokenOrg, Lexer } = require_api4();
    var fragments = {};
    var f = fragments;
    ...
    var Newline = createToken({ name: "Newline", pattern: /\n|\r\n/ });
    ...
    var IKey = createToken({ name: "IKey", pattern: Lexer.NA });
    var IQuotedKey = createToken({
      name: "IQuotedKey",
      pattern: Lexer.NA,
      categories: [IKey]
    });
    var IUnquotedKey = createToken({
      name: "IUnquotedKey",
      pattern: Lexer.NA,
      categories: [IKey]
    });
    var IString = createToken({ name: "IString", pattern: Lexer.NA });
    FRAGMENT(
      "basic_unescaped",
      /[\u0020-\u0021]|[\u0023-\u005B]|[\u005D-\u007E]|[\u0080-\uFFFF]/
    );
    ...
    var IInteger = createToken({
      name: "IInteger",
      pattern: Lexer.NA
    });
    var DecimalInt = createToken({
      name: "DecimalInt",
...
// node_modules/@toml-tools/lexer/lib/api.js
var require_api5 = __commonJS({
  "node_modules/@toml-tools/lexer/lib/api.js"(exports2, module2) {
    var { Lexer } = require_api4();
    var { tokensArray, tokensDictionary } = require_tokens2();
...
// node_modules/@toml-tools/parser/lib/parser.js
var require_parser2 = __commonJS({
  "node_modules/@toml-tools/parser/lib/parser.js"(exports2, module2) {
    var { CstParser } = require_api4();
    var { tokensDictionary: t } = require_api5();
...
// node_modules/@toml-tools/parser/lib/api.js
var require_api6 = __commonJS({
  "node_modules/@toml-tools/parser/lib/api.js"(exports2, module2) {
    var { tokenize } = require_api5();
    var { TomlParser } = require_parser2();
...
// node_modules/prettier-plugin-toml/lib/printer-utils.js
var require_printer_utils = __commonJS({
  "node_modules/prettier-plugin-toml/lib/printer-utils.js"(exports2, module2) {
...
// node_modules/prettier-plugin-toml/lib/printer.js
var require_printer = __commonJS({
  "node_modules/prettier-plugin-toml/lib/printer.js"(exports2, module2) {
    var { BaseTomlCstVisitor } = require_api6();
    var { tokensDictionary: t } = require_api5();
    var {
      trimComment,
      collectComments,
      ...
      arrItemProp,
      getSingle
    } = require_printer_utils();
    var { concat, join, line, hardline, softline, ifBreak, indent, group } = require_standalone().doc.builders;
        ...
        for (let i = 0; i < itemsCst.length; i++) {
          ...
          if (cstItem.name === "val") {
            ...
            if (itemsCst[i + 1] !== void 0) {
              ...
              if (nextPossibleComment !== void 0 && nextPossibleComment.tokenType === t.Comment && nextPossibleComment.startLine === valEndLine) {
                i++;
...
// node_modules/prettier-plugin-toml/lib/api.js
var require_api7 = __commonJS({
  "node_modules/prettier-plugin-toml/lib/api.js"(exports2, module2) {
    var { locStart, locEnd } = require_loc();
    var { parse } = require_api6();
...
export default require_api7();
//# sourceMappingURL=prettier-plugin-toml.js.map
