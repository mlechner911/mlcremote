...
type Props = {
  ...
  onToggleTheme: (t: 'dark' | 'light' | 'auto') => void
  isControlled?: boolean
}

export default function SettingsPopup({ isControlled, autoOpen, showHidden, onToggleAutoOpen, onToggleShowHidden, hideMemoryUsage, onToggleHideMemoryUsage, onClose, onLanguageChange, maxEditorSize, onMaxFileSizeChange, uiMode, onToggleUiMode, onLogout, theme, onToggleTheme }: Props) {
